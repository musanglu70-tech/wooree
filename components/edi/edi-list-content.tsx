    ...
    <div className="space-y-4">
      ...
      <section className="flex flex-wrap items-center justify-between gap-4">
        ...
        <button
          ...
          className="inline-flex h-10 items-center justify-center gap-2 rounded-lg border border-[#e2e8f0] bg-[#ffffff] px-4 text-sm font-medium text-[#475569] transition-colors hover:border-[#4f6ef7] hover:text-[#4f6ef7] disabled:cursor-not-allowed disabled:opacity-50"
        >
          ...
          <table className="w-full min-w-[900px] text-left text-sm">
            <thead>
              <tr className="border-b border-[#e2e8f0] bg-[#f8fafc]">
                <th className="px-5 py-3 font-medium text-[#475569]">처방월</th>
