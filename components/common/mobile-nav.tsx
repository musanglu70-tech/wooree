...
export function MobileNav() {
  ...
  return (
    <>
      {/* 상단 헤더 */}
      <header className="sticky top-0 z-30 flex h-14 items-center justify-between border-b border-[#e7ddd0] bg-[#ffffff] px-4 md:hidden">
      ...
      {/* 하단 네비게이션 */}
      <nav className="fixed inset-x-0 bottom-0 z-30 flex h-16 items-stretch border-t border-[#e7ddd0] bg-[#ffffff] md:hidden">
